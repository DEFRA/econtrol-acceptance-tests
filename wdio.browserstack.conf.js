...
export const config = {
  ...
  baseUrl: `https://econtrol-acceptance-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `econtrol-acceptance-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `econtrol-acceptance-tests-${process.env.ENVIRONMENT}`
        },
